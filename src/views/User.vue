<template>
  <div class="container py-5">
    ...
    <div class="row">
      <div class="col-4">
        <!-- UserFollowingsCard -->
        <UserFollowingsCard v-bind:profileFollowings="profile.Followings" />

        <!-- UserFollowersCard -->
        <UserFollowersCard v-bind:profileFollowers="profile.Followers" />
      </div>

      <div class="col-8">
        <!-- UserCommentsCard -->
        <UserCommentsCard v-bind:profileComments="profile.Comments" />

        <!-- UserFavoritedRestaurantsCard -->
        <UserFavoritedRestaurantsCard v-bind:profileFavoritedRestaurants="profile.FavoritedRestaurants" />
